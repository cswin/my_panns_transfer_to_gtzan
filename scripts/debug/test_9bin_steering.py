...
def test_9bin_steering():
    """Test 9-bin steering signals with better sample distribution."""
    ...
    if 'metadata' in signals_9bin and 'binning_system' in signals_9bin.get('metadata', {}):
        ...
        print("   🎯 Using 9-bin steering signals with better sample distribution!")
    else:
    ...
    for strength in strengths:
        print(f"\n🔍 Testing 9-BIN steering with strength: {strength}")
        ...
        for sample_idx, (features, true_val, true_aro, audio_name) in enumerate(real_data):
            ...
            # Prepare steering signals (TARGET-MATCHED, 9-bin)
    ...
    if best_val_improvement > 0.01 or best_aro_improvement > 0.01:
        print("   🎉 SUCCESS: 9-bin steering improves predictions!")
    elif best_val_improvement > -0.01 and best_aro_improvement > -0.01:
        print("   ✅ GOOD: 9-bin steering maintains performance!")
    else:
        print("   ⚠️  MARGINAL: 9-bin steering shows small effects")
