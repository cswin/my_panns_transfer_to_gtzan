...
def main():
    print("📊 Simple Steering Performance Curve")
    ...
    print(f"🎯 Using {num_samples} samples per strength")
    ...
    output_path = 'tmp/simple_steering_performance_curve.png'
    ...
    # Print key results
    print("\n" + "="*70)
    print("📊 STEERING PERFORMANCE SUMMARY")
    print("="*70)
    ...
    with open('tmp/simple_steering_results.json', 'w') as f:
        json.dump(results, f, indent=2)
    
    print(f"\n📊 Clean performance plot saved to: {output_path}")
    print(f"📊 Results saved to: tmp/simple_steering_results.json")
