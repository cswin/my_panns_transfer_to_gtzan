...
def main():
    ...
    baseline_log = "workspaces/emotion_regression/logs/emotion_main/FeatureEmotionRegression_Cnn6_NewAffective/pretrain=True/loss_type=mse/augmentation=mixup/batch_size=48/freeze_base=True/0000.log"
    lrm_log = "workspaces/emotion_feedback_stable/logs/emotion_main/FeatureEmotionRegression_Cnn6_LRM/pretrain=True/loss_type=mse/augmentation=mixup/batch_size=32/freeze_base=True/0001.log"
